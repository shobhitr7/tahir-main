            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-danger">Add Return Product</h5>
                    </div>
                    <hr/>
                    <form action="{{route('store.return.product')}}" method="POST">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input  type="number" step="0.01" class="form-control" name="return_amount" id="inputConfirmPassword2" placeholder="Enter Transport Amount">
                            </div>
                        </div>
                    <div class="row mb-3">
                        <label for="inputEnterYourName" class="col-sm-3 col-form-label">Return Reason</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" id="inputAddress4" name="return_reason" rows="3" placeholder="Describe The Reason"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
